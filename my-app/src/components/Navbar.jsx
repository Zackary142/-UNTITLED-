...
export default function Navbar({ pageTitle }) {
  ...
  return (
    <div className="navbar bg-base-100 border-b border-base-300 px-4 min-h-[52px]">
      ...
      <div className="navbar-start gap-3">
        ...
        <button className="flex items-center gap-1 text-sm text-base-content/60 hover:text-base-content">
          Workspace
      ...
      <div className="navbar-end gap-3">
        ...
        <div className="border border-base-300 rounded-lg px-3 py-1 text-xs font-medium bg-base-100">
